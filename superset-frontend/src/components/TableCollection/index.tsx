            ...
            return (
              ...
              >
                {row.cells.map(cell => {
                  ...
                  let renderedCell: any = null;
                  try {
                    renderedCell = cell.render('Cell');
                  } catch (error) {
                    // Keep the table usable if a single row cell renderer hits
                    // malformed data. The broken cell will render empty, but the
                    // rest of the list can still load.
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span data-test="cell-text">{renderedCell}</span>
                      </span>
                    </td>
                  );
                })}

...
describe('FacePile', () => {
  ...
  it('handles missing users without crashing', () => {
    const { container: emptyContainer } = render(<FacePile users={null} />, {
      store,
    });

    expect(emptyContainer.querySelectorAll('.ant-avatar')).toHaveLength(0);
  });
});

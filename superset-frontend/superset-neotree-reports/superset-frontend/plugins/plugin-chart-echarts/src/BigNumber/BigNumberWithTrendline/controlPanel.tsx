        ...
        [
          {
            ...
            config: {
              ...
              default: false,
              description: t(
                'When checked, a decrease in value is shown in green and an increase in red. ' +
                  'Use for metrics where lower values are desirable (e.g. error rates, case fatality rate).',
              ),
              visibility(props: ControlPanelsContainerProps) {
                return !!props.form_data.compare_lag;
              },
            },
          },
        ],
